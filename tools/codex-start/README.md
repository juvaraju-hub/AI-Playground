...
export CODEX_START_MCP_PASSIVE_SERVERS="chrome-devtools kubernetes terraform-cloud terraform github context7 datadog_us datadog_eu aws-knowledge-mcp-server openaiDeveloperDocs victorops"
